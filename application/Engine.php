...
class Engine {
    ...
    public function init() {
        ...
        $this->loader->register('request', '\application\net\Request');
        $this->loader->register('response', '\application\net\Response');
        $this->loader->register('router', '\application\net\Router');
        $this->loader->register('view', '\application\template\View', array(), function($view) use ($self) {
            $view->path = $self->get('application.views.path');
        });
